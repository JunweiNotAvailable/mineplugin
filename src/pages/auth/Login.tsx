    ...
    <div className='app-body flex'>
      ...
      <div className='flex-1 flex justify-center'>
        <div className='login-form flex flex-col justify-center'>
          ...
          <button className='main-button mt-4 py-1' onClick={login}>Log in</button>
          <Link to={'/signup'} className='text-center mt-4 py-1 hover:text-primary-hover'>Sign up</Link>
        </div>
      </div>
    </div>
  )
