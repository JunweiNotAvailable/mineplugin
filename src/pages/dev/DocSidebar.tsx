...
const DocSidebar: React.FC<FetchProps> = ({ fetchLink }) => {
    ...
    <aside className='w-80 box-border px-4 pb-4 sticky top-0 shadow scroller'>
      ...
      <div className='mt-2 flex flex-col text-sm'>
        ...
        {dirs.map(dir => <div className='mb-1'>
          <div className='flex justify-between items-center text-gray-500 cursor-pointer p-1 mb-1 sticky top-0 z-10 bg-white' onClick={() => setDirsOpen({ ...dirsOpen, [dir.name]: !dirsOpen[dir.name] })}>
        ...
        {/* files */}
        {files.map(file => <div className='flex justify-between items-center text-gray-400 cursor-pointer my-1 p-1'>
